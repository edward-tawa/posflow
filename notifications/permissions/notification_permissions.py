...
class NotificationPermission(BasePermission):
    """
    POS Notification permission rules:
    - Managers, Staff, Superusers: can view notifications of their company.
    - Sales, Marketing: can only view notifications of their company.
    - Users cannot access notifications from other companies.
    """
