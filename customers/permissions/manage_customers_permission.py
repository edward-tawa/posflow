...
class ManageCustomersPermission(BasePermission):
    """
    POS Customer permission rules:
    - Managers, Staff, Superusers: can view and modify customers of their company.
    - Sales, Marketing: can only view customers of their company.
    - Users cannot access customers from other companies.
    """
