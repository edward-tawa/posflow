...
register_crud_signals(
    ...
    get_description=lambda instance, created=False, deleted=False: (
        f"SupplierCreditNote '{instance.credit_note_number if instance else None}' has been"
    ...
    get_metadata=lambda instance, created=False, deleted=False: {
        ...
        'supplier_credit_note_name': instance.credit_note_number if instance else None,
        'created': created,
    }
)