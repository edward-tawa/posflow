...
class PurchasePaymentAllocation(CreateUpdateBaseModel):
    ...
    currency = models.ForeignKey('currency.Currency', on_delete=models.PROTECT, default=1, related_name='purchase_payment_allocations')
    total_allocated_amount = models.DecimalField(max_digits=12, decimal_places=2, default=0)
